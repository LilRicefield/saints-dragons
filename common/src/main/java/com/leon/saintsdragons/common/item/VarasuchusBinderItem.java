...
public class VarasuchusBinderItem extends Item {
    ...
    public @NotNull InteractionResult interactLivingEntity(@NotNull ItemStack stack,
        ...
        if (!(target instanceof Varasuchus drake)) {
        ...
        if (!drake.canBeBound()) {
            player.displayClientMessage(
                    Component.translatable("saintsdragons.message.varasuchus_cannot_be_captured"),
                    true);
            return InteractionResult.FAIL;
        }
    ...
    private ItemStack captureDrake(ItemStack stack, Varasuchus drake, Player player) {
        ...
        player.displayClientMessage(
                Component.translatable("saintsdragons.message.varasuchus_captured", drake.getName().getString()),
                true);
    ...
    private boolean releaseDrake(ItemStack stack, Player player, BlockPos pos) {
        ...
        Varasuchus newDrake = new Varasuchus(ModEntities.VARASUCHUS.get(), serverLevel);
        ...
        player.displayClientMessage(
                Component.translatable("saintsdragons.message.varasuchus_released", drakeName),
                true);
    ...
    public void appendHoverText(@NotNull ItemStack stack,
        ...
        tooltip.add(Component.translatable("saintsdragons.tooltip.varasuchus.description"));
        if (isBound(stack)) {
            String name = getBoundRiftDrakeName(stack);
            if (name != null && !name.isEmpty()) {
                tooltip.add(Component.translatable("saintsdragons.tooltip.varasuchus.bound", name));
            }
            tooltip.add(Component.translatable("saintsdragons.tooltip.varasuchus.right_click_to_release"));
        } else {
            tooltip.add(Component.translatable("saintsdragons.tooltip.varasuchus.empty"));
            tooltip.add(Component.translatable("saintsdragons.tooltip.varasuchus.right_click_varasuchus_to_bind"));
        }
    }
