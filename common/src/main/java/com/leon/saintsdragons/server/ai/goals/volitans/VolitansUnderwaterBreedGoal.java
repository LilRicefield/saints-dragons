...
public class VolitansUnderwaterBreedGoal extends DragonBreedGoal<Volitans> {
    ...
    public VolitansUnderwaterBreedGoal(Volitans dragon, double speedModifier, double partnerRange, double breedDistanceSqr) {
    ...
    public void tick() {
        ...
        if (closeEnough) {
            ...
            this.dragon.getAIMovement().moveToGroundTarget(this.partner, speed, false);
        }
