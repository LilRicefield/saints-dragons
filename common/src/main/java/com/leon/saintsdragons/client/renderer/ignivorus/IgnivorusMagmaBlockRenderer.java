...
public class IgnivorusMagmaBlockRenderer extends EntityRenderer<IgnivorusMagmaBlockEntity> {
    ...
    @Override
    public void render(@NotNull IgnivorusMagmaBlockEntity entity, float entityYaw, float partialTick,
