...
public final class ForgeDragonAttributesConfig {
    ...
    static {
        ...
        VOLITANS_TAMING_CHANCE_BASE = builder.defineInRange("taming_chance_base", 5.0, 0.0, 100.0);
        VOLITANS_TAMING_CHANCE_HEARTY = builder.defineInRange("taming_chance_hearty", 3.0, 0.0, 100.0);
