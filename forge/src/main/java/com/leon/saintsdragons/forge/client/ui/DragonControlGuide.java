package com.leon.saintsdragons.forge.client.ui;
...
public class DragonControlGuide extends DragonUIElement {
    ...
    private void updateControls() {
        ...
        controls.add(ControlEntry.forKey(DragonRideInputHandler.DRAGON_ASCEND, Component.translatable("saintsdragons.ui.control.ascend"), COLOR_MOVEMENT));
        controls.add(ControlEntry.forKey(DragonRideInputHandler.DRAGON_DESCEND, Component.translatable("saintsdragons.ui.control.descend"), COLOR_MOVEMENT));
        controls.add(ControlEntry.forKey(DragonRideInputHandler.DRAGON_ACCELERATE, Component.translatable("saintsdragons.ui.control.accelerate"), COLOR_MOVEMENT));

        if (rideable != null) {
            addAbilityEntry(rideable.getPrimaryRiderAbility(), DragonRideInputHandler.DRAGON_PRIMARY_ABILITY, "saintsdragons.ui.control.ability_primary", COLOR_ABILITY);
            addAbilityEntry(rideable.getSecondaryRiderAbility(), DragonRideInputHandler.DRAGON_SECONDARY_ABILITY, "saintsdragons.ui.control.ability_secondary", COLOR_ABILITY);
            addAbilityEntry(rideable.getTertiaryRiderAbility(), DragonRideInputHandler.DRAGON_TERTIARY_ABILITY, "saintsdragons.ui.control.ability_tertiary", COLOR_ABILITY);
            // Add toggle melee entry
            controls.add(ControlEntry.forKey(DragonRideInputHandler.DRAGON_TOGGLE_MELEE, Component.translatable("saintsdragons.ui.control.toggle_melee"), COLOR_ATTACK));
        }
