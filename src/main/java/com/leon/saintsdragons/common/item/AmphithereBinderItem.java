 ...
 */
public class AmphithereBinderItem extends Item {
    ...
    public AmphithereBinderItem(Properties properties) {
        super(properties);
    }
    
    @Override
    public @NotNull InteractionResult interactLivingEntity(@NotNull ItemStack stack, @NotNull Player player, @NotNull LivingEntity target, @NotNull InteractionHand hand) {
        if (target instanceof AmphithereEntity amphithere) {
     ...
     */
    private ItemStack captureAmphithere(ItemStack stack, AmphithereEntity amphithere, Player player) {
        ...
        tag.put("AmphithereData", amphithereData);
    ...
    public void appendHoverText(@NotNull ItemStack stack, @Nullable Level level, @NotNull List<Component> tooltip, @NotNull TooltipFlag flag) {
        if (isBound(stack)) {
            ...
            if (amphithereName != null) {
                tooltip.add(Component.translatable("saintsdragons.tooltip.amphithere_binder.bound", amphithereName));
            }
            tooltip.add(Component.translatable("saintsdragons.tooltip.amphithere_binder.right_click_to_release"));
        } else {
