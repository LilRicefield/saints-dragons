 ...
 * When an untamed dragon eats fish from the ground, it has a chance to become tamed.
 */
public class LightningDragonTemptGoal extends Goal {
    ...
    public LightningDragonTemptGoal(LightningDragonEntity dragon, double speedModifier, Ingredient items, boolean canScare) {
        this.dragon = dragon;
    ...
    public boolean canUse() {
        // Don't use this goal if dragon is sleeping, dying, or being ridden
    ...
    /**
     * Find the nearest fish item that the dragon can eat
     */
    ...
    public boolean canContinueToUse() {
        // Continue if target fish still exists and dragon hasn't reached it
        if (targetFish == null || !targetFish.isAlive()) {
            return false;
        }
        
        // Stop if dragon is too far from target
    ...
    /**
     * Handle fish consumption and potential taming when dragon reaches fish items
     */
    private void handleFishConsumption(ItemEntity fishItem) {
        ...
        // Find the nearest player who might be "feeding" the dragon
        ...
        fishItem.discard();
            ...
            // Play eating sound
            dragon.playSound(
                com.leon.saintsdragons.common.registry.ModSounds.DRAGON_CHUFF.get(),
                1.0f,
            ...
            if (dragon.isTame()) {
                // Tamed dragon: heal when eating fish
                ...
                // Untamed dragon: taming chance (same 1 in 10 chance as right-click taming)
    ...
    /**
     * Find the nearest player who might be "feeding" the dragon by dropping fish
     */
