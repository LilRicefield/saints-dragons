...
public class AmphithereMagmaVolleyAbility extends DragonAbility<AmphithereEntity> {
    ...
    public AmphithereMagmaVolleyAbility(DragonAbilityType<AmphithereEntity, AmphithereMagmaVolleyAbility> type,
    ...
    private void fireVolley() {
        ...
        for (int i = 0; i < BLOCKS_PER_VOLLEY; i++) {
            ...
            AmphithereMagmaBlockEntity block = new AmphithereMagmaBlockEntity(server, spawnPos,
