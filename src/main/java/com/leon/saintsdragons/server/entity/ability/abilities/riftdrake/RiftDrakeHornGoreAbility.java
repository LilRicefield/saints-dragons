 ...
 */
public class RiftDrakeHornGoreAbility extends DragonAbility<RiftDrakeEntity> {
    ...
    public RiftDrakeHornGoreAbility(DragonAbilityType<RiftDrakeEntity, RiftDrakeHornGoreAbility> type, RiftDrakeEntity user) {
    ...
    private void applyGore(LivingEntity target) {
        ...
        // Very strong directional knockback away from dragon head
    ...
    private boolean isAllied(RiftDrakeEntity dragon, Entity other) {
