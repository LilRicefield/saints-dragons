...
public class Stegonaut extends DragonEntity implements DragonSleepCapable, SoundHandledDragon {
        ...
        if (!this.level().isClientSide) {
            ...
            if (player instanceof net.minecraft.server.level.ServerPlayer serverPlayer) {
                var advancement = serverPlayer.server.getAdvancements()
                    .getAdvancement(com.leon.saintsdragons.SaintsDragons.rl("tame_stegonaut"));
                if (advancement != null) {
    ...
    private StegonautPlayDeadGoal playDeadGoal;
     ...
     */
    public void setPlayDeadGoal(StegonautPlayDeadGoal goal) {
