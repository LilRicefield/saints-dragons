...
import com.leon.saintsdragons.server.entity.controller.lightningdragon.RaevyxPhysicsController;
...
import com.leon.saintsdragons.server.entity.controller.lightningdragon.RaevyxRiderController;
...
public class Raevyx extends RideableDragonBase implements FlyingAnimal, RangedAttackMob,
    ...
    private static final Map<String, VocalEntry> VOCAL_ENTRIES = new VocalEntryBuilder()
            ...
            .add("purr", "action", "animation.raevyx.purr", ModSounds.RAEVYX_PURR, 0.8f, 1.05f, 0.05f, true, false, false)
