...
public class RaevyxLightningArcParticle extends TextureSheetParticle {
    ...
    @OnlyIn(Dist.CLIENT)
    public static class Factory implements ParticleProvider<RaevyxLightningArcData> {
    ...
    @OnlyIn(Dist.CLIENT)
    public static class ChainFactory implements ParticleProvider<RaevyxLightningChainData> {
        private final SpriteSet spriteSet;
